          ...
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                {{-- <div class="form-group">
                  <input name="username" type="text" class="form-control form-control-user @error('username')is-invalid @enderror" id="exampleInputName" placeholder="User Name">
                  @error('username')
                  <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div> --}}
                ...
                <div class="form-group row">
                  ...
                  <!-- <div class="col-sm-12 mt-4">
                    <select class="form-control" aria-label="Default select example" id="role" name="role" style="border-radius: 20px; height:50px">
